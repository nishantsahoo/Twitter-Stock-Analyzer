...
def getSentiment():
    wb = open_workbook('Historical_Data/amazon_tweets.xlsx')
    sentiment_dict = {}
...
def calDiff():
    wb = open_workbook('Historical_Data/amazon_stock_data.xlsx')
    change_dict = {}
    for sheet in wb.sheets():
        number_of_rows = sheet.nrows
        number_of_columns = sheet.ncols
...
def calTrends():
    wb = open_workbook('Historical_Data/amazon_trends.xlsx')
    trends = []
    for sheet in wb.sheets():
        number_of_rows = sheet.nrows
        number_of_columns = sheet.ncols
